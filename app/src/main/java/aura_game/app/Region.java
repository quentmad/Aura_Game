...
public class Region {
    ...
    public Item takeableItemFromRegion(Entity ent) {
        ...
        List<CollidableObject> objColList = getGridItem().getCollidingObjectsWithoutItself(ent.getHitboxFlat(), ent).getList();
    ...
    /*
     * Met a jour l'emplacement des objets au sein de la liste des objets de la map
     */
    public void updateItemBasicObjectsOnRegion(Item item) {
        basicObjectsOnRegion.remove(item);
        addSortedObject(item);
